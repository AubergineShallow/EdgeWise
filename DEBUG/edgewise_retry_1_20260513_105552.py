...
# The original error was likely due to an unclosed string literal in the provided snippet,
# but the core logic error in the context of the prompt is that the script was
# attempting to use a placeholder DATA_CSV instead of the actual global variable.
# We assume DATA_CSV is defined globally before this script runs.
